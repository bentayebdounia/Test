 ...
 */
public class journal_stock extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tableau_jrnl_stock.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "motif", "Nom de produit", "Poids", "Pièces", "Etape ", "Nom de Stock"
            }
        ) {
        ...
        jPanel1.add(rechercheIcon, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 60, -1, -1));

        stockBox.setFont(new java.awt.Font("Microsoft PhagsPa", 0, 16)); // NOI18N
        stockBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "<Tous>", "Chambre Froide", "Dépot", " ", " " }));
        jPanel1.add(stockBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 60, 270, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(journal_stock.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new journal_stock().setVisible(true);
            }
        });
    }

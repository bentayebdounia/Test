 ...
 */
public class journalSortie extends javax.swing.JFrame {

    /**
     * Creates new form journalSortie
     */
    public journalSortie() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID sortie", "Produit", "Poids", "Pièces", "Heure", "Agent de sortie", "Stock"
            }
        ));
        ...
        dateLabel.setFont(new java.awt.Font("Microsoft PhagsPa", 0, 16)); // NOI18N
        dateLabel.setText("Date");
        dateLabel.setPreferredSize(new java.awt.Dimension(32, 30));
        jPanel1.add(dateLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 60, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(journalSortie.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new journalSortie().setVisible(true);
            }
        });
    }

 ...
 */
public class journalNettoyage extends javax.swing.JFrame {

    /**
     * Creates new form journalNettoyage
     */
    public journalNettoyage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID caisse", "Produit", "Poids", "Pièces", "Heure", "Agent de nettoyage", "Stock"
            }
        ));
        ...
        jPanel1.add(date, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 60, 140, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(journalNettoyage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new journalNettoyage().setVisible(true);
            }
        });
    }

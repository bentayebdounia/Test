 ...
 */
public class tranchierPouletPanel extends javax.swing.JPanel {

   ClasseVerification verify = new ClasseVerification();
   
    public tranchierPouletPanel() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(79, 139, 42), 15, true));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 0, 80, 20));

        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 845, 220));
        ...
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(88, 60, -1, 28));
        ...
        jPanel2.add(poids, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 60, 280, 28));

        jLabel7.setFont(new java.awt.Font("Microsoft PhagsPa", 0, 16)); // NOI18N
        jLabel7.setText("Pieces ");
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 60, -1, 28));
        ...
        jPanel2.add(piece, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 60, 231, 28));

        jLabel8.setFont(new java.awt.Font("Microsoft PhagsPa", 0, 16)); // NOI18N
        jLabel8.setText("Stock");
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(92, 100, -1, 28));

        stockBox.setFont(new java.awt.Font("Microsoft PhagsPa", 0, 14)); // NOI18N
        stockBox.setPreferredSize(new java.awt.Dimension(72, 26));
        jPanel2.add(stockBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 100, 622, 28));
        ...
        jPanel2.add(bouttonAjouter1, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 150, 140, 29));
        ...
        jPanel2.add(bouttonAjouter3, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 150, 140, 29));

        jLabel4.setFont(new java.awt.Font("Microsoft PhagsPa", 0, 16)); // NOI18N
        jLabel4.setText("Poids de bon");
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 20, -1, 28));
        ...
        jPanel2.add(poidsBon, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 20, 280, 28));

        jLabel5.setFont(new java.awt.Font("Microsoft PhagsPa", 0, 16)); // NOI18N
        jLabel5.setText("Pieces de bon");
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 20, -1, 28));
        ...
        jPanel2.add(pieceBon, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 20, 231, 28));

        add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 247, 845, 210));

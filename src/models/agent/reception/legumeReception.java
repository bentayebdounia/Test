 ...
 */
public class legumeReception extends javax.swing.JPanel {

    
    ClasseVerification verify = new ClasseVerification();
    public legumeReception() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        fournisseurText.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                fournisseurTextActionPerformed(evt);
            }
        });
        ...
        jPanel1.add(bouttonAjouter, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 160, 217, 29));

        jComboBox2.setFont(new java.awt.Font("Microsoft PhagsPa", 0, 14)); // NOI18N
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Bon de livraison ", "Bon de réception" }));
        jComboBox2.setPreferredSize(new java.awt.Dimension(72, 26));
        jPanel1.add(jComboBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(531, 70, 240, 28));
        ...
        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 40, 845, 220));
        ...
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 100, -1, 28));
        ...
        jPanel2.add(poids, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 100, 280, 28));

        jLabel7.setFont(new java.awt.Font("Microsoft PhagsPa", 0, 16)); // NOI18N
        jLabel7.setText("Pieces ");
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 100, -1, 28));
        ...
        jPanel2.add(piece, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 100, 231, 28));

        jLabel8.setFont(new java.awt.Font("Microsoft PhagsPa", 0, 16)); // NOI18N
        jLabel8.setText("Stock");
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 140, -1, 28));

        stockBox.setFont(new java.awt.Font("Microsoft PhagsPa", 0, 14)); // NOI18N
        stockBox.setPreferredSize(new java.awt.Dimension(72, 26));
        jPanel2.add(stockBox, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 140, 622, 28));
        ...
        jPanel2.add(validerBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 190, 140, 29));
        ...
        jPanel2.add(annulerBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 190, 140, 29));

        jLabel4.setFont(new java.awt.Font("Microsoft PhagsPa", 0, 16)); // NOI18N
        jLabel4.setText("Poids de bon");
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 60, -1, 28));
        ...
        jPanel2.add(poidsBon, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 60, 280, 28));

        jLabel5.setFont(new java.awt.Font("Microsoft PhagsPa", 0, 16)); // NOI18N
        jLabel5.setText("Pieces de bon");
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 60, -1, 28));
        ...
        jPanel2.add(pieceBon, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 60, 231, 28));

        jComboBox3.setFont(new java.awt.Font("Microsoft PhagsPa", 0, 14)); // NOI18N
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pomme de terre", "Laitue", "Tomate", "Oignon", "Choux", "Carottes", " " }));
        jComboBox3.setPreferredSize(new java.awt.Dimension(72, 26));
        jPanel2.add(jComboBox3, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 20, 280, 28));

        add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 290, 845, 240));
    ...
    private void fournisseurTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fournisseurTextActionPerformed
       
    }//GEN-LAST:event_fournisseurTextActionPerformed
